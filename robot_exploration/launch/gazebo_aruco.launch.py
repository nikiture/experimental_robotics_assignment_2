...
def generate_launch_description():
    test_robot_description_share = FindPackageShare(package='experimental_robotics_assignment_1_ros2').find('experimental_robotics_assignment_1_ros2')
    ...
    #rob_model = xacro.process_file(default_model_path)
    ...
    robot_state_publisher_node = Node(
        ...
        #parameters = [{'robot_description': xacro.process_file(default_model_path).toxml()}]
    )
